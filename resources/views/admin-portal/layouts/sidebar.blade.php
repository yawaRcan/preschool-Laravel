        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                      <li>  <a href="{{ route('Add_courses')}}"><span>Add Courses</span></a></li>
                        <li><a href="{{ route('course_list')}}">Courses List</a></li>
                        <li><a href="{{ route('subject')}}">Subject Add</a></li>
                        <li><a href="{{ route('subjectList')}}">Subject List</a></li>
                    </ul>
                </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href=" {{ route('addstudent')}}">Student Add</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="{{ route('departmentList')}}">Department List</a></li>
                        <li><a href="{{ route('department')}}">Department Add</a></li>
                        {{-- <li><a href="{{ route('department.edit') }}">Department Edit</a></li> --}}
                    </ul>
                </li>
                <li class="submenu">
